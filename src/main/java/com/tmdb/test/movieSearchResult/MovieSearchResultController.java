...
public class MovieSearchResultController {
    ...
    public MovieSearchResult getMovies(@RequestParam String query) throws IOException, InterruptedException {
        ...
        HttpRequest request = HttpRequest.newBuilder()
            .GET()
            .uri(URI.create(rootUri + "movie?query=" + encodedQuery + "&api_key=66b5c7fda06a1512aab3bf907e61d85c"))
